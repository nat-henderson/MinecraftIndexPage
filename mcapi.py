...
class MinecraftJsonApi (object):
    ...
    def __init__(self, host='localhost', port=20059, username='mcadmin',
        password='correcthorsebatterystaple', salt='nothinginterestingwhatsoeverisgoinghereatall', autoload_methods=True):
        self.host = host
...
if __name__ == '__main__':
    ...
    # Read params
     paramDefaults = {'host': 'localhost', 'port':20059, 'username':'mcadmin', 'password':'correcthorsebatterystaple', 'salt':'nothinginterestingwhatsoeverisgoinghereatall'}
